...
public enum TokenType {
	TOK_EOF, TOK_ERR, TOK_INT, TOK_PLUS, TOK_MINUS, TOK_MULT, TOK_PLUS_EQUALS, TOK_IDENTIFIER, TOK_KW_IF, TOK_BOOL, TOK_KW_VAR
		...
		, TOK_EQUALS, TOK_ASS, TOK_LEQ, TOK_LESS, TOK_GEQ, TOK_GREAT, TOK_NEQ, TOK_NEG, TOK_PRIM_TYPE, TOK_PRIM_FUNC_TUPLE
		, TOK_CHAR, TOK_KW_WHILE, TOK_EXP, TOK_NIL, TOK_BEGIN_CONCAT, TOK_KW_NULL, TOK_KW_NEW, TOK_KW_PRINT, TOK_LISTFUNC_HEAD, TOK_LISTFUNC_TAIL;
}
